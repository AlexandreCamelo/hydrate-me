...
import Adolescente from '../imagens/hAdolescente.png';
import Adulto from '../imagens/hAdulto.png';
import Velho from '../imagens/hVelho.png';
import MuitoVelho from '../imagens/hMuitoVelho.png';
...
function telaIdadeHomem({ navigation }) {
    ...
    return (
            <ImageBackground source={FundoAgua} style={Estilos.fundo}>
                <View style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <OpcaoIdade aoClicar={() => { VarGlobais.glFaixaEtaria = '18a55'; console.log('Faixa etaria escolhida: ' + VarGlobais.glFaixaEtaria); navigation.navigate('peso') }} CaminhoImagem={Adulto} largImagem={53} altImagem={80} textoBotao='18 a 55 anos' />
                    <OpcaoIdade aoClicar={() => { VarGlobais.glFaixaEtaria = '56a65'; console.log('Faixa etaria escolhida: ' + VarGlobais.glFaixaEtaria); navigation.navigate('peso') }} CaminhoImagem={Velho} largImagem={53} altImagem={80} textoBotao='56 a 65 anos' />
                    <OpcaoIdade aoClicar={() => { VarGlobais.glFaixaEtaria = '66ouMais'; console.log('Faixa etaria escolhida: ' + VarGlobais.glFaixaEtaria); navigation.navigate('peso') }} CaminhoImagem={MuitoVelho} largImagem={53} altImagem={80} textoBotao='maior que 65' />
                </View>
            </ImageBackground>
    )
